...
def sendMessage(chatid, text):
    if int(chatid) < 0:
        ...
        keyboard.add(KeyboardButton('Пары сегодня'),KeyboardButton('Пары завтра'))
        keyboard.add(KeyboardButton('Бот помощь'))
        return bot.send_message(chatid, text, reply_markup=keyboard)
