...
def inline_caps(update, context):
    ...
    if site_status != "200 OK":
        results.append(InlineQueryResultArticle(
            id="nosite",
            title="⚠ ptpit.ru: "+site_status,
            description="сайт недоступен",
            input_message_content=InputTextMessageContent("Сайт ptpit.ru недоступен"),
    ...
    if not query in groups_format:
        results.append(InlineQueryResultArticle(
            ...
            input_message_content=InputTextMessageContent("Группа не найдена"),
            thumb_url="https://cdn4.iconfinder.com/data/icons/hand-drawn-ui/100/ikonka_002-512.png"
        ))
    else:
        results.append(InlineQueryResultArticle(
